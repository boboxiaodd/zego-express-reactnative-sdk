...
(function (ZegoScreenCaptureExceptionType) {
    ...
    ZegoScreenCaptureExceptionType[ZegoScreenCaptureExceptionType["VideoNotSupported"] = 1] = "VideoNotSupported";
    /** The capture target fails, such as the monitor is unplugged and the window is closed. */
    ZegoScreenCaptureExceptionType[ZegoScreenCaptureExceptionType["AudioNotSupported"] = 2] = "AudioNotSupported";
    ...
    ZegoScreenCaptureExceptionType[ZegoScreenCaptureExceptionType["AudioCreateFailed"] = 3] = "AudioCreateFailed";
    /** MediaProjection request for dynamic permissions was denied. */
    ZegoScreenCaptureExceptionType[ZegoScreenCaptureExceptionType["MediaProjectionPermissionDenied"] = 4] = "MediaProjectionPermissionDenied";
    /** Capture is not started. Need to start capturing with [startScreenCapture] first. */
    ZegoScreenCaptureExceptionType[ZegoScreenCaptureExceptionType["NotStartCapture"] = 5] = "NotStartCapture";
    /** Screen capture has already started, repeated calls failed. You need to stop the capture with [stopScreenCapture] first. */
    ZegoScreenCaptureExceptionType[ZegoScreenCaptureExceptionType["AlreadyStarted"] = 6] = "AlreadyStarted";
    /** Failed to start the foreground service. */
    ZegoScreenCaptureExceptionType[ZegoScreenCaptureExceptionType["ForegroundServiceFailed"] = 7] = "ForegroundServiceFailed";
    ...
    ZegoScreenCaptureExceptionType[ZegoScreenCaptureExceptionType["SourceNotSpecified"] = 8] = "SourceNotSpecified";
    /** System error exception. For example, low memory, etc. */
    ZegoScreenCaptureExceptionType[ZegoScreenCaptureExceptionType["SystemError"] = 9] = "SystemError";
...
(function (ZegoObjectSegmentationType) {
    ...
    ZegoObjectSegmentationType[ZegoObjectSegmentationType["GreenScreenBackground"] = 1] = "GreenScreenBackground";
