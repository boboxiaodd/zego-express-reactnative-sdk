...
export default class ZegoExpressEngine {
    ...
    static getAuthInfo(appSign){
        return ZegoExpressEngineImpl.getAuthInfo(appSign);
    }
    static setFilter(filterName){
        ZegoExpressEngineImpl.setFilter(filterName);
    }
    static setFilterLevel(filterLevel) {
        ZegoExpressEngineImpl.setFilterLevel(filterLevel);
    }
    static setBeauty(name, value) {
        ZegoExpressEngineImpl.setBeauty(name,value);
    }
    ...
    startRecordingCapturedData(config, channel) {
        return ZegoExpressEngineImpl.getInstance().startRecordingCapturedData(config, channel);
    }
    /**
    ...
    stopRecordingCapturedData(channel) {
        return ZegoExpressEngineImpl.getInstance().stopRecordingCapturedData(channel);
    }
    /**
     ...
     */
    enableCustomVideoCapture(enable, config, channel) {
        return ZegoExpressEngineImpl.getInstance().enableCustomVideoCapture(enable, config, channel);
    }
    /**
